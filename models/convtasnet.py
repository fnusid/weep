...
# from wespeaker.models.speaker_model import get_speaker_model ##change this to your embedding model
...
class ConvTasNet(nn.Module):
    ...
    def forward(self, x, embeddings):
        ...
        if x.dim() >= 3:
            raise RuntimeError(
                "{} accepts 1/2D tensor as input, but got {:d}".format(

...
from models.tfgridnet import TFGridNet #TSE
...
config_path = Path("/home/sidharth./codebase/wesep/confs/config_gridnet.yaml")
...
class E2EpSE(pl.LightningModule):
    def __init__(
        ...
        self.model = TFGridNet(**hp.model_args.tse_model)
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(
        project="pDCCRN_2sp",
        name="pDCCRN_2sp_tfgridnet",
        # name='test_run',
        log_model=False,
        save_dir="/mnt/disks/data/model_ckpts/pDCCRN_2sp_tfgridnet+/wandb_logs",
    )
    ...
    ckpt = pl.callbacks.ModelCheckpoint(
        ...
        dirpath="/mnt/disks/data/model_ckpts/pDCCRN_2sp_tfgridnet+/"
    )
    ...
    trainer = pl.Trainer(
        accelerator='gpu',
        strategy="ddp",          # good to be explicit for multi-GPU
